...
import { ShieldCheck, Cpu, BarChart2, Zap, Mail, ChevronRight, LayoutGrid } from 'lucide-react';
        ...
        <div className="lg:col-span-3 space-y-8">
           <div>
             ...
             <ul className="space-y-3 text-slate-400 text-sm">
               <li className="hover:text-cyan-400 cursor-pointer transition-colors">How Scanning Works</li>
               <li className="hover:text-cyan-400 cursor-pointer transition-colors">Data Verification</li>
               <li className="hover:text-cyan-400 cursor-pointer transition-colors">The AI Engine</li>
             </ul>
           </div>
           ...
           <div>
             ...
             <ul className="space-y-3 text-slate-400 text-sm">
               <li className="hover:text-purple-400 cursor-pointer transition-colors">Score Calculation</li>
               <li className="hover:text-purple-400 cursor-pointer transition-colors">Breakdown Metrics</li>
               <li className="hover:text-purple-400 cursor-pointer transition-colors">Priority Tiers</li>
             </ul>
           </div>
           ...
           <div>
             ...
             <ul className="space-y-3 text-slate-400 text-sm">
               <li className="hover:text-emerald-400 cursor-pointer transition-colors">PAS Framework</li>
               <li className="hover:text-emerald-400 cursor-pointer transition-colors">Avoiding Spam Filters</li>
               <li className="hover:text-emerald-400 cursor-pointer transition-colors">Closing Rates</li>
             </ul>
           </div>
        </div>
